      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          >
            ...
            {/* Authenticated User - Show Logout & Profile */}
            {user ? (
              <>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={logout}
                  className="bg-red-500 text-white px-4 py-2 rounded-xl hover:bg-red-600 transition-colors shadow-lg"
                >
                  Logout <LogOut className="w-4 h-4 ml-2 inline" />
                </motion.button>
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
              ...
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                {user ? (
                  <>
                    ...
                    <button
                      onClick={logout}
                      className="w-full bg-red-500 text-white px-4 py-2 rounded-xl hover:bg-red-600 transition-colors shadow-lg"
                    >
                      Logout
                    </button>
                  </>
                  ...
                  <>
                    <button
                      ...
                      className="w-full bg-primary text-white px-4 py-2 rounded-xl hover:bg-primary/90 transition-colors shadow-lg"
                    >
                      Sign Up
                    </button>
                    <button
                      onClick={() => navigate("/login")}
                      className="w-full bg-secondary text-white px-4 py-2 rounded-xl hover:bg-secondary/90 transition-colors shadow-lg"
                    >
                      Login
                    </button>
                  </>
