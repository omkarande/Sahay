  ...
  const reviews = [
    {
      ...
      rating: 5,
      comment:
        "This platform completely transformed my career journey! I was confused about what career path to choose, but the AI-driven recommendations and assessments gave me a clear direction. I landed my first job in just three months with their personalized guidance!",
    },
    {
      id: 2,
      ...
      rating: 4,
      comment:
        "As a mid-career professional, I was looking to transition into data science, but I had no idea where to start. This platform provided a tailored learning pathway, connecting me with the right courses, mentorship, and job opportunities. Within six months, I secured a role as a Data Analyst!",
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "This platform helped me pick the right ones based on my goals and even connected me to a like-minded community. ",
      avatar: "/api/placeholder/32/32",
    },
    {
      id: 3,
      ...
      rating: 5,
      comment:
        "This platform makes career counseling so much easier! It provides structured insights into students' strengths and weaknesses, helping them choose the right path. It’s a game-changer for educators and mentors.",
      avatar: "/api/placeholder/32/32",
    },
    {
      id: 3,
      ...
      rating: 5,
      comment:
        " I finally found a job that aligns with my passion and skills, thanks to this platform!",
      avatar: "/api/placeholder/32/32",
    },
  ];
    ...
    <div className="relative min-h-screen bg-gradient-to-br from-blue-50 to-white overflow-hidden">
      ...
      <div className="container mx-auto px-6 pt-20">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">
                Perfect Job Matching with Personalized Learning, Your Way!
              </span>
            </motion.div>
            ...
            >
              Create a learning path that adapts to your strengths, interests,
              and aspirations. Step by step, we’re here to guide you forward And
              Achieve your dream Job. Your journey, your rules.
            </motion.p>
          ...
          <motion.div style={{ scale }} className="flex-1 relative h-[600px]">
            <motion.div
              animate={{
                rotate: [0, 10, -10, 0],
                scale: [1, 1.1, 0.9, 1],
...
const ChatBot = () => {
  ...
  const handleMouseMove = (e) => {
    if (isDragging) {
      ...
      const newY = Math.max(
        0,
        Math.min(
          window.innerHeight - (isMinimized ? 60 : 600),
  ...
  const ChatBox = ({ position, isMinimized }) => {
    const chatStyle = {
