...
import { User, Plus, X, Upload, Loader2, AlertCircle } from "lucide-react";
...
const Profile = () => {
  ...
  const updateProgress = () => {
    ...
    const totalProgress =
      (personalProgress + educationProgress + skillsProgress) / 3;
  ...
  const handleResumeUpload = async (
    ...
    try {
      ...
      const autofillResponse = await fetch(
        "http://localhost:5004/api/auto-fill-resume",
        {
          method: "POST",
      ...
      setFormData((prev) => ({
        personalInfo: {
          ...
          lastName:
            parsedData.personal_information?.name
              ?.split(" ")
              .slice(1)
              .join(" ") || "",
        ...
        skills: {
          technical:
            parsedData.technical_skills?.map((skill: any) => ({
              skill: skill.name,
              level: skill.level,
            })) || [],
          soft:
            parsedData.soft_skills?.map((skill: any) => ({
              skill: skill.name,
              level: skill.level,
            })) || [],
          languages:
  ...
  const validateStep = (step: number): boolean => {
    switch (step) {
      ...
      case 3:
        return (
          formData.skills.technical.some((skill) => !!skill.skill) ||
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <Input
          ...
          onChange={(e) =>
            handleInputChange("personalInfo", "githubUrl", e.target.value)
          }
        />
        <Input
  ...
  const renderEducation = () => (
    <div className="space-y-6">
      <Select
        ...
        onValueChange={(value) =>
          handleInputChange("education", "currentLevel", value)
        }
      >
        <SelectTrigger>
      ...
      <Input
        ...
        onChange={(e) =>
          handleInputChange("education", "field", e.target.value)
        }
      />
      ...
      <div className="space-y-4">
        ...
        {formData.education.achievements.map((achievement, index) => (
          <div key={index} className="flex gap-2">
            ...
            <Button
              ...
              size="icon"
              onClick={() => {
                const newAchievements = formData.education.achievements.filter(
                  (_, i) => i !== index
                );
                handleInputChange("education", "achievements", newAchievements);
              }}
        ...
        <Button
          variant="outline"
          onClick={() => {
            handleInputChange("education", "achievements", [
              ...formData.education.achievements,
              "",
            ]);
          }}
        >
        ...
        {formData.skills.technical.map((skill, index) => (
          <div key={index} className="flex gap-4">
            ...
            <Button
              ...
              size="icon"
              onClick={() => {
                const newSkills = formData.skills.technical.filter(
                  (_, i) => i !== index
                );
                handleInputChange("skills", "technical", newSkills);
              }}
        ...
        {formData.skills.soft.map((skill, index) => (
          <div key={index} className="flex gap-4">
            ...
            <Button
              ...
              size="icon"
              onClick={() => {
                const newSkills = formData.skills.soft.filter(
                  (_, i) => i !== index
                );
                handleInputChange("skills", "soft", newSkills);
              }}
        ...
        {formData.skills.languages.map((lang, index) => (
          <div key={index} className="flex gap-4">
            ...
            <Button
              ...
              size="icon"
              onClick={() => {
                const newLangs = formData.skills.languages.filter(
                  (_, i) => i !== index
                );
                handleInputChange("skills", "languages", newLangs);
              }}
