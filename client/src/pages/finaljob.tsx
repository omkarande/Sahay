...
const JobSearch = () => {
  ...
  const handleProfileSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("http://localhost:5002/api/jobs/match", {
        method: "POST",
        body: formData,
      });
        ...
        <div className="mb-8">
          <Card className="bg-blue-50">
            <CardHeader>
              ...
              <CardDescription>
                You have admin access. You can post new job opportunities and
                manage existing ones.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-gray-600 mb-4">
                Jobs you post will be immediately visible to all students. Make
                  ...
                  <Badge
                    variant={
                      job.match_percentage > 75
                        ? "default" // using "default" for high match
                        : job.match_percentage > 50
                        ? "destructive" // using "destructive" for medium match
                        : "secondary"
                    }
